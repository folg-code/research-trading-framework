...
Status: **ACCEPTED**. Reviewed against [Current Status](CURRENT_STATUS.md) on 2026-09-17. This page is the phase index and dependency map; detailed plans live in `roadmap/`, completed sprint evidence in the [Archive](../archive/README.md), and implemented behavior in [Reference](../reference/README.md).
...
| 8A BTC futures dry-run slice | Complete (Sprint 062 closed, incl. VPS deploy/rollback) | [Current Status](CURRENT_STATUS.md) |
...
| 18 Dashboard Research Evidence Views | 18A approved (2026-09-18, PRD: [docs/product/PRD-dashboard-strategy-research-evidence.md](../product/PRD-dashboard-strategy-research-evidence.md)); no sprint opened yet. 18B/18D directional, no PRD/ADR/sprint. 18C folded into 18A. | [Phase 18](roadmap/PHASE_18_DASHBOARD_RESEARCH_EVIDENCE.md) |
| 19 Market Analysis Catalog Expansion (2026-09 batch) | Complete — approved 2026-09-17; Wave 0, Sprint 065 (Tooling), Sprint 066 (Wave A, 20 components) and Sprint 067 (Wave B, 6 components) all closed and merged to main (#552-#571) — all 26+1 PRD components implemented (`trend.movement_efficiency` excepted) | [Phase 19](roadmap/PHASE_19_MARKET_ANALYSIS_CATALOG_EXPANSION.md) |

...
| Current increment | Phase 19 complete; Phase 18 increments 18A and 18B both **done** (18A 2026-09-18, 18B 2026-09-22); 18D approved (maintainer, 2026-09-22, [PRD](../product/PRD-dashboard-robustness-research-evidence.md)) — Wave 0 not opened yet; 17C — Data Manager still not opened, lower priority |
...
| Active sprint | None open — Phase 18D's PRD is approved; Wave 0 architecture triage is next before any sprint opens. |

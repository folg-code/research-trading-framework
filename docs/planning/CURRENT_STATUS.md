...
Active Sprint: SPRINT_061 — Portfolio Story, Content and Direction
  ...
  T005 is in progress; T006–T008 remain.
...
and the two explicitly future-only directions. T005 extends the safe
projection to every supported, safely identifiable catalog run and records the
approved visibility/grouping/release decisions. T006–T008 still cover the
...
| 061 | Portfolio Story, Content and Direction Completion (Phase 16, increment 16D) | IN PROGRESS | T001 Done (#503); T002–T004 Done (#506); T005 in progress; T006–T008 remain — see `docs/planning/sprints/SPRINT_061.md` |

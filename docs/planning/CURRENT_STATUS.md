...
| Current increment | Phase 19 complete; Phase 18 increment 18A **done** (2026-09-18) — PRD fully implemented across Sprints 068-071 (merged via #574/#577/#580/#583); 18B approved (2026-09-18, [PRD](../product/PRD-dashboard-signal-research-evidence.md)) — Wave 0 not started, no sprint opened; 17C — Data Manager still not opened, lower priority |
...
| Active sprint | None — 18A closed with Sprint 071's merge. 18B approved, Wave 0 not started. |

...
Current Phase: Sprint 036 research infra audit — Stage 0.5 + MTF/Parquet harness measured
Current Milestone: Stage 1 (D-REP-03 / D-REP-07) scoped by T006 measurements
...
Recent: S036 T001–T006 on sprint (#272–#279, #278). Next: Stage 1 T007 (H2 justified; H6 defer; H4 unmeasured). Track: audit → S037 DSL/components → AI/ML later.
```
...
| 036 | Research infra audit (DSL/component gate) | IN_PROGRESS | T001–T006 on `sprint/research-infra-audit`; T007 next |

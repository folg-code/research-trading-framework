...
Current Milestone: Sprint 022 kickoff - AWS runtime entry point and configuration
...
| 022 | AWS Runtime MVP for BTC Futures Dry Run (Phase 8A) | IN_PROGRESS | 2 / 9 tasks |

...
Current Milestone: Sprint 022 observability - CloudWatch logs and heartbeat metric
...
- Current active target: Sprint 022, AWS runtime MVP.
...
| 022 | AWS Runtime MVP for BTC Futures Dry Run (Phase 8A) | IN_PROGRESS | 7 / 9 tasks |

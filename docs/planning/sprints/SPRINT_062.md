...
| T006 | Add unit, integration and container smoke tests for restart, stale feed, invalid/corrupt state, status unavailability, schema compatibility and dashboard regression | T002–T005 | tests | high | Ready — T002–T005 merged | — |

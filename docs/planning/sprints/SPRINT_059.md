...
| T005 | Refresh the overview with the product thesis, shared-domain map, six independent workflow entries and maturity labels, using concise English content and existing visual components | T004 | `apps/dashboard` overview/content | standard | In review | pending |

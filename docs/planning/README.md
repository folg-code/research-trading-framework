...
Catalog of `docs/planning/`. For taxonomy and reading paths see **[../README.md](../README.md)**.

---

## Progress (read first for status)

| File | Purpose |
|------|---------|
| [CURRENT_STATUS.md](CURRENT_STATUS.md) | Snapshot: phase, completed work, next capability |
...
| [sprints/SPRINT_038.md](sprints/SPRINT_038.md) | Session Range Structure (Wave 0 open) |
| [sprints/S038_WAVE0_DECISIONS.md](sprints/S038_WAVE0_DECISIONS.md) | Sprint 038 Wave 0 decisions (D-S038-01 … D-S038-08; 04–07 pending lock) |
...
| [sprints/SPRINT_013.md](sprints/SPRINT_013.md) | OHLCV Strategy Research MVP / Phase 6A (completed) |

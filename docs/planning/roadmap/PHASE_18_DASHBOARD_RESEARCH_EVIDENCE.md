...
| 18B Signal Research evidence views | Workflow overview, forward-drift heatmap, adjusted forward drift, MFE/MAE relation, context timeline and persistence | **APPROVED (maintainer, 2026-09-18)** — [PRD](../../product/PRD-dashboard-signal-research-evidence.md); Wave 0 complete and accepted ([decisions](PHASE_18B_WAVE0_DECISIONS.md)); [Sprint 072](../sprints/SPRINT_072.md) (Milestone 1a: root-mismatch fix, 3-run Signal backfill, and a 4th previously-unknown Strategy Research run found and backfilled to 18A parity) merged; [Sprint 073](../sprints/SPRINT_073.md) (Milestone 1b: `mfe_mae_pairs`, `adjusted_forward_drift`, `context_timeline`/`persistence` computed, backfilled and published) done, PR pending. Milestone 1 now complete; Milestone 2 (dashboard UI) not opened yet. |

...
| 18B Signal Research evidence views | Workflow overview, forward-drift heatmap, adjusted forward drift, MFE/MAE relation, context timeline and persistence | **APPROVED (maintainer, 2026-09-18)** — [PRD](../../product/PRD-dashboard-signal-research-evidence.md); Wave 0 complete and accepted ([decisions](PHASE_18B_WAVE0_DECISIONS.md), 2026-09-22) — the root-mismatch fix and the 3-run backfill both turned out to need no new code, only correctly invoking existing tools (verified directly against the 6 real runs). No sprint opened yet. |

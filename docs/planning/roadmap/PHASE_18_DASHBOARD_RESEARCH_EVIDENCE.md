...
| 18B Signal Research evidence views | Workflow overview, forward-drift heatmap, adjusted forward drift, MFE/MAE relation, context timeline and persistence | **APPROVED (maintainer, 2026-09-18)** — [PRD](../../product/PRD-dashboard-signal-research-evidence.md); Wave 0 complete and accepted ([decisions](PHASE_18B_WAVE0_DECISIONS.md)); [Sprint 072](../sprints/SPRINT_072.md) (Milestone 1a) and [Sprint 073](../sprints/SPRINT_073.md) (Milestone 1b: `mfe_mae_pairs`, `adjusted_forward_drift`, `context_timeline`/`persistence` computed, backfilled and published) both merged — Milestone 1 complete. [Sprint 074](../sprints/SPRINT_074.md) (Milestone 2: dashboard UI over all ten `signal_research_evidence` tables) done, PR pending. |

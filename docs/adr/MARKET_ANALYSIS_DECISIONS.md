...
> `docs/archive/phases/phase-03-market-analysis/SPRINT_003.md` and
> `docs/archive/phases/phase-03-market-analysis/S003_WAVE0_ARCHITECTURE_CLOSURE.md` for that

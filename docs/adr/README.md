...
| [ADR-0035](ADR-0035-complete-public-catalog-publication.md) | Complete Public Catalog Publication and Immutable Releases | ACCEPTED | Sprint 061 |
| [ADR-0036](ADR-0036-vps-dry-run-runtime-and-status-boundary.md) | VPS Dry-Run Runtime Boundary: Topology, State Ownership, Public Status Schema, Lifecycle and Threat Model | ACCEPTED | Sprint 062 |

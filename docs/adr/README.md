...
This is the single ADR index. `Area` names the primary owning capability; cross-cutting effects remain in the ADR itself. Status and amendment notes are preserved from the decision record.

| ADR | Title | Status | Sprint | Area |
|---|---|---|---|---|
| [ADR-0001](ADR-0001-modular-monolith.md) | Modular Monolith | ACCEPTED | Sprint 001 | Foundation / cross-cutting |
| [ADR-0002](ADR-0002-separate-src-and-user-data.md) | Separate `src` and `user_data` | ACCEPTED | Sprint 001 | Foundation / cross-cutting |
| [ADR-0003](ADR-0003-utc-internal-time.md) | UTC Internal Time | ACCEPTED | Sprint 001 | Foundation / cross-cutting |
| [ADR-0005](ADR-0005-market-analysis-domain-and-taxonomy.md) | Market Analysis Domain and Taxonomy | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-0007](ADR-0007-dataset-lifecycle-and-publication.md) | Dataset Lifecycle and Publication | ACCEPTED | Sprint 002 | Market Data |
| [ADR-0008](ADR-0008-parquet-historical-storage.md) | Parquet Historical Storage | ACCEPTED | Sprint 002 | Market Data |
| [ADR-MA-001](ADR-MA-001-market-analysis-domain-boundaries.md) | Market Analysis Domain Boundaries | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-002](ADR-MA-002-component-and-implementation-identity.md) | Component and Implementation Identity | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-003](ADR-MA-003-parameter-canonicalization-and-fingerprinting.md) | Parameter Canonicalization and Fingerprinting | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-004](ADR-MA-004-analysis-data-view-and-data-ownership.md) | AnalysisDataView and Data Ownership | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-005](ADR-MA-005-analysis-result-and-output-identity.md) | AnalysisResult and Output Identity | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-006](ADR-MA-006-dependency-dag-and-execution-planning.md) | Dependency DAG and Execution Planning | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-007](ADR-MA-007-analysis-workspace-and-derived-data.md) | Analysis Workspace and Derived Data | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-008](ADR-MA-008-cache-identity-and-cache-scope.md) | Cache Identity and Cache Scope | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-009](ADR-MA-009-warmup-causality-and-availability.md) | Warm-up, Causality and Availability | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-010](ADR-MA-010-external-analytical-libraries.md) | External Analytical Libraries | ACCEPTED | Sprint 003 | Market Analysis |
| [ADR-MA-011](ADR-MA-011-batch-versus-incremental-execution.md) | Batch Versus Incremental Execution | ACCEPTED | Sprint 003 | Market Analysis |
...
| [ADR-0013](ADR-0013-signal-research-analytics-boundary.md) | Signal Research Analytics Boundary | ACCEPTED | Sprint 010 | Research |
| [ADR-0014](ADR-0014-historical-archive-import-and-market-trade-storage.md) | Historical Archive Import and MarketTrade Partitioned Storage | ACCEPTED | Sprint 011 | Market Data |
| [ADR-0015](ADR-0015-derived-ohlcv-from-trades.md) | Derived OHLCV from Published Trades | ACCEPTED | Sprint 012 | Market Data |
| [ADR-0016](ADR-0016-ohlcv-strategy-research-mvp.md) | OHLCV Strategy Research MVP | ACCEPTED | Sprint 013 | Research |
| [ADR-0017](ADR-0017-strategy-research-inspection-boundary.md) | Strategy Research Inspection Boundary | ACCEPTED | Sprint 014 | Research |
| [ADR-0018](ADR-0018-continuous-futures-materialization.md) | Continuous Futures Materialization | ACCEPTED | Sprint 015 | Market Data |
| [ADR-0019](ADR-0019-robustness-research-mvp.md) | Robustness Research MVP | ACCEPTED | Sprint 016 | Research |
| [ADR-0020](ADR-0020-model-research-methodology-mvp.md) | Model Research Methodology MVP | ACCEPTED | Sprint 017 | Research |
| [ADR-0021](ADR-0021-live-dry-run-execution-demo.md) | Live Dry-Run Execution Demo | ACCEPTED | Sprint 018 | Execution |
| [ADR-0022](ADR-0022-repository-top-level-layout.md) | Repository Top-Level Layout | ACCEPTED | Sprint 029 | Foundation / cross-cutting |
| [ADR-0023](ADR-0023-predictive-research-boundary.md) | Predictive Research Domain Boundary | ACCEPTED (§7 amended by ADR-0029) | Sprint 039 | Research |
| [ADR-0024](ADR-0024-machine-learned-state-promotion.md) | Promotion Conditions for Machine-Learned Market Analysis States | ACCEPTED | Sprint 044 | Market Analysis |
| [ADR-0025](ADR-0025-binance-usdm-historical-klines-import.md) | Binance USD-M Historical Klines Import | ACCEPTED | Sprint 045 | Market Data |
| [ADR-0026](ADR-0026-operator-cli-framework-and-placement.md) | Operator CLI: Framework, Placement and Config Contract | ACCEPTED | Sprint 046 | Applications |
| [ADR-0027](ADR-0027-operator-authored-strategy-loading.md) | Operator-Authored Strategy Loading (`strategy_file` + `build_strategy()`) | ACCEPTED | Sprint 047 | Models / Strategy |
| [ADR-0028](ADR-0028-bracket-exit-and-equity-relative-sizing.md) | Bracket Exits and Equity-Relative Sizing: Widening the Strategy Model Gate | ACCEPTED (declined for Sprint 047; resumed with corrections for Sprint 048) | Sprint 047 / 048 | Models / Strategy |
| [ADR-0029](ADR-0029-promoted-predictive-artifact.md) | Promoted Predictive Artifact: Parameter Format, Promotion Store, and the Narrow ADR-0023 §7 Amendment | ACCEPTED | Sprint 049 | Research |
| [ADR-0031](ADR-0031-predictive-sample-spec-and-task.md) | Predictive Sample Universe (`SampleSpec`) and Research Task Taxonomy (`PredictiveTask`) | ACCEPTED | Sprint 056 | Research |
| [ADR-0032](ADR-0032-predictive-run-verdict-artifact.md) | Predictive Run Verdict Artifact: Vocabulary, Rule Set, and Sidecar Schema | ACCEPTED | Sprint 057 | Research |
| [ADR-0033](ADR-0033-predictive-score-delivery-boundary.md) | Predictive Score Delivery Boundary for Strategy Research (16C) | ACCEPTED | Sprint 058 | Research |
...
| ADR-0030 | Inference-Time Availability Enforcement | PLANNED (conditional on the S049-T001 finding) | TBD | Market Analysis |

Market Analysis binding decisions D-001–D-036 remain authoritative in
[Market Analysis decision register](MARKET_ANALYSIS_DECISIONS.md) (formerly `MARKET_ANALYSIS_WITH_DECISIONS.md`, dissolved by Sprint 055 T008). Sprint 003 materialized the engine subset above as
accepted ADRs.
...
- `docs/adr/MARKET_ANALYSIS_DECISIONS.md` (formerly `MARKET_ANALYSIS_WITH_DECISIONS.md`)

...
moved to `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md`, so this document stays a working
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §4.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §5.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §7.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §9.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §11.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §13A.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §13B.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §13C.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §13D.
...
Full detail: `docs/archive/planning/ROADMAP_COMPLETED_PHASES.md` §13E.
...
`docs/reference/examples/BTC_PREDICTIVE_STUDY.md` for the full detail; this stub is not rewritten

...
> See `docs/archive/phases/cross-cutting/SPRINT_055_T002_VISION_TARGET_IA.md` and
...
- **Composition Over Inheritance** (`ARCHITECTURE_FOUNDATIONS.md` former
  ...
  **pending a Cursor-side move** to `.cursor/rules/ARCHITECTURE_CONTROL.md`
  ...
  it is parked in `docs/archive/superseded/SUPERSEDED_LAYOUT_PROPOSALS.md` pending
...
- **Controlled Technology Adoption** (`ARCHITECTURE_FOUNDATIONS.md` former
  ...
  deleted — it is parked in `docs/archive/superseded/SUPERSEDED_LAYOUT_PROPOSALS.md`

...
Architecture Sources:
  ...
  - docs/vision/WORKFLOWS_AI_ADR.md (§3.12–3.14 Signal Research)
...
| closure | (pending) | `docs/sprint-017-research-methodologies` | [RESEARCH_METHODOLOGIES.md](../../../reference/workflows/RESEARCH_METHODOLOGIES.md) — all research workflows |

...
(`docs/reference/examples/BTC_PREDICTIVE_STUDY.md`), already present on the
...
- `docs/archive/phases/phase-16-research-workbench/SPRINT_058.md` — T001-T005's task-level record.
- `docs/reference/examples/BTC_PREDICTIVE_STUDY.md` — Sprint 052's `every_bar` /

...
Source: `docs/planning/sprints/S051_BTC_DATA_INVENTORY.md` (Sprint 051's
...
`docs/planning/sprints/S052_WAVE0_DECISIONS.md` D-S052-03's correction
...
Source data
  ...
  import manifest:       rows_decoded=1,311,840, rows_rejected=0, gaps=[]
                         (docs/planning/sprints/S051_BTC_DATA_INVENTORY.md §2/§3)
...
per `docs/planning/sprints/S051_BTC_DATA_INVENTORY.md`'s recorded command)
...
recorded in `docs/planning/sprints/SPRINT_052.md` (S052-T003 through
S052-T005 outcome notes) and `docs/planning/sprints/S052_WAVE0_DECISIONS.md`.

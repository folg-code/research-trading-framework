    ...
    conditional = pl.DataFrame(
        {
            ...
            "mae_mean_delta": [0.0],
            "forward_return_median_true": [0.00008],
            "forward_return_median_false": [0.00012],
            "forward_return_median_delta": [-0.00004],
            "mfe_median_true": [0.0001],
            "mfe_median_false": [0.00015],
            "mfe_median_delta": [-0.00005],
            "mae_median_true": [-0.00008],
            "mae_median_false": [-0.00009],
            "mae_median_delta": [0.00001],
        },

...
def test_csv_file_inspector_detects_columns_and_timestamp_candidates(
    ...
    result = inspector.inspect(ohlcv_sample_1m_path)
    ...
    assert result.row_estimate == OHLCV_SAMPLE_1M_ROW_COUNT
...
def test_csv_file_inspector_satisfies_protocol(ohlcv_sample_1m_path: Path) -> None:
